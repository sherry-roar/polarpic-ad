...
/**
 * @ingroup UNR_API
 * @brief Declare the memory block is ready for receiving data.
 * @attention The call of this function does NOT mean the data will not be received before this function is called.
 * @param[in] blk_h The block that is ready for receiving data.
 */
uru_status_t unr_blk_recv_ready(unr_blk_h blk_h);

/**
 * @ingroup UNR_API
 * @brief Declare partial of the memory block is ready for receiving data.
 * @attention The call of this function does NOT mean the data will not be received before this function is called.
 * @param[in] blk_h     The memory block whose part of region is ready for receiving data.
 * @param[in] offset    The start address offset of the region corresponding to the memory block.
 ...
 *        The parameters are the same as \ref unr_blk_send_start except that they are arrays.
 ...
 *        The parameters are the same as \ref unr_blk_part_send_start except that they are arrays.
 * @param[in] num_sends     The number of RDMA Writes.
 * @param[in] loc_blk_h_arr The array of local memory block handles.
 * @param[in] loc_sig_h_arr The array of local signal handles.
