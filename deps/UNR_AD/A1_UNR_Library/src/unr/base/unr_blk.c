...
uru_status_t unr_blk_recv_ready(unr_blk_h blk_h) {
    URU_ASSERT_REASON(unr_channels, "unr_init should be called before calling %s", __func__);
    URU_NOT_IMPLEMENTED_EXIT();
    return URU_STATUS_OK;
}

uru_status_t unr_blk_part_recv_ready(unr_blk_h blk_h, size_t offset, size_t size) {
    URU_ASSERT_REASON(unr_channels, "unr_init should be called before calling %s", __func__);
    URU_NOT_IMPLEMENTED_EXIT();
    return URU_STATUS_OK;
}

uru_status_t unr_blk_send_start(
    unr_blk_h loc_blk_h, unr_sig_h loc_sig_h,
    unr_blk_h rmt_blk_h, unr_sig_h rmt_sig_h) {
    ...
    unr_rdma_plan_create(
        ...
        (unr_blk_t*)&rmt_blk_h, (unr_sig_t*)&rmt_sig_h, NULL,
        (unr_plan_t**)(&plan_h));
    return URU_STATUS_OK;
}

uru_status_t unr_blk_send_plan(
    unr_blk_h loc_blk_h, unr_sig_h loc_sig_h,
    unr_blk_h rmt_blk_h, unr_sig_h rmt_sig_h,
    unr_plan_h* plan_h) {
...
uru_status_t unr_blk_part_send_start(
    unr_blk_h loc_blk_h, unr_sig_h loc_sig_h, size_t loc_offset, size_t size,
    unr_blk_h rmt_blk_h, unr_sig_h rmt_sig_h, size_t rmt_offset) {
    ...
    unr_rdma_plan_create(
        ...
        (unr_blk_t*)&rmt_blk_h, (unr_sig_t*)&rmt_sig_h, &rmt_offset,
        (unr_plan_t**)(&plan_h));
    return URU_STATUS_OK;
}

uru_status_t unr_blk_part_send_plan(
    unr_blk_h loc_blk_h, unr_sig_h loc_sig_h, size_t loc_offset, size_t size,
    unr_blk_h rmt_blk_h, unr_sig_h rmt_sig_h, size_t rmt_offset,
    unr_plan_h* plan_h) {
...
uru_status_t unr_blk_send_batch_start(
    size_t num_sends,
    unr_blk_h* loc_blk_h_arr, unr_sig_h* loc_sig_h_arr,
    unr_blk_h* rmt_blk_h_arr, unr_sig_h* rmt_sig_h_arr) {
    ...
    unr_rdma_plan_create(
        ...
        (unr_blk_t*)rmt_blk_h_arr, (unr_sig_t*)rmt_sig_h_arr, NULL,
        (unr_plan_t**)(&plan_h));
    return URU_STATUS_OK;
}

uru_status_t unr_blk_send_batch_plan(
    size_t num_sends,
    unr_blk_h* loc_blk_h_arr, unr_sig_h* loc_sig_h_arr,
    unr_blk_h* rmt_blk_h_arr, unr_sig_h* rmt_sig_h_arr,
    unr_plan_h* plan_h) {
...
uru_status_t unr_blk_part_send_batch_start(
    size_t num_sends,
    unr_blk_h* loc_blk_h_arr, unr_sig_h* loc_sig_h_arr, size_t* loc_offset, size_t* size,
    unr_blk_h* rmt_blk_h_arr, unr_sig_h* rmt_sig_h_arr, size_t* rmt_offset) {
    ...
    unr_rdma_plan_create(
        ...
        (unr_blk_t*)rmt_blk_h_arr, (unr_sig_t*)rmt_sig_h_arr, rmt_offset,
        (unr_plan_t**)(&plan_h));
    return URU_STATUS_OK;
}

uru_status_t unr_blk_part_send_batch_plan(
    size_t num_sends,
    unr_blk_h* loc_blk_h_arr, unr_sig_h* loc_sig_h_arr, size_t* loc_offset, size_t* size,
    unr_blk_h* rmt_blk_h_arr, unr_sig_h* rmt_sig_h_arr, size_t* rmt_offset,
    unr_plan_h* plan_h) {
...
uru_status_t unr_rdma_plan_create(
    ...
    unr_blk_t* rmt_blk_arr, unr_sig_t* rmt_sig_arr, size_t* rmt_offset_arr,
    ...
    for (int i = 0; i < num_sends; i++) {
        ...
        size_t* uri_mem_offset = uru_mpi->same_node[rmt_blk_arr[i].dst_rank] ? unr_channels->inter_uri_mem_h_offset : unr_channels->intra_uri_mem_h_offset;
    ...
    for (int i = 0; i < unr_plan_p->num_uri_plan; i++) {
        if (uri_plan_num_wrts[i]) {
            ...
            uri_rdma_plan_create(
                uri_channel, once_now, uri_plan_num_wrts[i],
...
uru_status_t unr_plan_start(unr_plan_h plan_h) {
    ...
    if (unr_plan_p->status != 2) {
        ...
        unr_rdma_plan_create(1, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, &unr_plan_p);
    }
    for (int i = 0; i < unr_plan_p->num_uri_plan; i++) {
