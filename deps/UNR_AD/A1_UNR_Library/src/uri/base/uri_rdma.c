...
uru_status_t uri_rdma_plan_create(
    uri_channel_h channel_h, uint8_t once_now, size_t num_wrt,
    uri_mem_h* loc_mem_h_arr, size_t* loc_offset_arr, uru_flag_t** loc_flag_p_arr, int64_t* loc_flag_add_arr, uint64_t* wrt_size_arr,
    ...
    return channel_p->func_ptrs->rdma_plan_create(
        channel_p, once_now, num_wrt,
        (uri_mem_t**)loc_mem_h_arr, loc_offset_arr, loc_flag_p_arr, loc_flag_add_arr, wrt_size_arr,
