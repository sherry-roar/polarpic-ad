module mod_parameters
    ...
    integer, parameter, dimension(6) :: nhalo = (/3, 3, 3, 3, 1, 1/)
    ...
    integer, save :: stat_scheme = 2
    logical, save :: stat_which_var(11)     ! deprecated
    ...
    subroutine readInputParam(fn_input)
        ...
        namelist /STATISTICS/ nt_init_stat, sample_interval, stat_scheme, stat_which_var
