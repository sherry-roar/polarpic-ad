...
contains
    ...
    subroutine outVorticity(fn_prefix, nt)
        ...
        call outputField(fn_prefix//vartag//'.h5', nt, (/nx, ny, nz/), st, sz, nhalo_zero, vartag, vor)
    ...
    subroutine outQ(fn_prefix, nt)
        ...
        call outputField(fn_prefix//vartag//'.h5', nt, (/nx, ny, nz/), st, sz, nhalo_zero, vartag, q)
    ...
    subroutine outLambda2(fn_prefix, nt)
        ...
        call outputField(fn_prefix//vartag//'.h5', nt, (/nx, ny, nz/), st, sz, nhalo_zero, vartag, lambda2)
    ...
    subroutine eigenvalue(a, x)
        ...
        AA = -sign(1.0_fp, R) * ( abs(R) + sqrt(cmplx(R*R-Q*Q*Q)) )**(1.0/3.0)
