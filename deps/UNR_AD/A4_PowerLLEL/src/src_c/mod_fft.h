...
extern void init_fft(int xsz[3], int ysz[3], char bctype_x[], char bctype_y[],
                     ...
                     kml_fft_plan fft_plan[2][2], double *fft_normfactor);
extern void execute_fft(kml_fft_plan plan, double *work);
// extern void execute_fft(kml_fft_plan plan, double *in, double *out);
extern void free_fft(kml_fft_plan plan[2][2]);
extern void get_eigen_values(int ist, int isz, int isz_global, char bctype[],
                             double *lambda);
